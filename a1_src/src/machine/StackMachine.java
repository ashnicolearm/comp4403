 ...
 * @version $Id: StackMachine.java 7 2013-02-22 05:39:30Z ianh $
 */
...
/********************************** Execution *******************************/
    ...
    private void execInstruction() {
        ...
        case BR_FALSE: /* If the second top value = FALSE_VALUE, 
            ...
            break;
        case COPY: /* Copy top-of-stack words from second-top-of-stack address 
                      to third-top-of-stack address */
            int copySize = pop();
            int fromAddr = fp + pop();
            int toAddr = fp + pop();
