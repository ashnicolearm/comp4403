 ...
 * @version $Id: Type.java 8 2013-02-22 06:25:04Z ianh $
...
public abstract class Type 
{
    ...
    public static class SubrangeType extends ScalarType {
        ...
        /** Symbol table scope in which subrange type defined */
        private Scope scope;

        public SubrangeType( Scope scope,
                ConstExp lowerExp, ConstExp upperExp ) {
    ...
    public static class ProductType extends Type {
        ...
        public ProductType resolveType( Position pos ) {
            ...
            return new ProductType( resolvedTypes );
        }
        @Override
        public boolean equals( Type other ) {
