 ...
 * @version $Id: Scanner.java 8 2013-02-22 06:25:04Z ianh $
...
public class Scanner {
      ...
      private int nextCh; /* The one character of look-ahead we need */
      ...
      public LexicalToken getNextToken() throws IOException {
          ...
          do {
              ...
              case '|':
                  ...
                  return new LexicalToken( Token.BAR, currentPosn );
              case '[':
                  if( nextCh == ']' ) {
                      nextCh = getNextChar();
